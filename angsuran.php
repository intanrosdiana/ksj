		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form" action="edit_angsuran.php" method="post">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"> ID Katagori </label>
						<div class="col-md-9">
							<input type="text" class="form-control" name="id_katagori" value="<?php echo $row ['id_katagori'] ;?>">
						</div>
					</div>
					<div class="form-group">
			...
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" method="post" action="save_angsuran.php" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"> ID Katagori </label>
						<div class="col-md-9">
							<select class="form-control" name="id_katagori">
							<?php
								$query = mysqli_query($conn, "SELECT * from katagori_pinjaman");
								while($fetch = mysqli_fetch_array($query)){
								echo "<option value='$fetch[id_katagori]'> $fetch[id_katagori] </option>";
								}
							?>							
							</select>
						</div>
